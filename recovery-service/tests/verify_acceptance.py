...
print("\n--- RUNNING CARVING ENGINE DIRECTLY ---")
engine = CATCHCarving()
output_dir = os.path.join(os.path.dirname(__file__), "..", "acceptance_carved_output")
try:
    result = engine.execute(image_src, output_dir=output_dir)
    print("\n--- PHOTOREC EXECUTION PROVENANCE ---")
